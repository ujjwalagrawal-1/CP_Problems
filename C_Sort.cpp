...
typedef vector<pair<ll, ll>> vec_pairl;
typedef vector<pair<ll, ll>> vec_pairl;
typedef vector<pair<ll, pair<ll, bool>>> vecdbplb;
typedef vector<pair<int, pair<int, bool>>> vecdbpb;
typedef queue<ll> ql;
...
void solve()
{
    ...
    while (q--)
    {
        ...
        for (int i = 0; i < 26; i++)
        {
            int radeh1 = 0;
            int radeh2 = 0;
            radeh1 += (temp1[i] - temp3[i]);
            radeh2 += (temp2[i] - temp4[i]);
            radeh += abs(radeh1 - radeh2);
        }
        cout << radeh / 2 << endl;
    }
}
