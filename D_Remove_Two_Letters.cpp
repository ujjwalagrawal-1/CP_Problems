...
// // Ye tu bhulega -> fixed concept For the k = 2 --- infinity..
// for the first test case -> What really Happens here is we start Checking from the i = 2  and make (answer = 1 becoz minimum answer always exist as 1) and basically what we check is -> A_ A_ A_ B_ C_ C_  if A  == A then we will again generate the Sequence as A_B_C_C_
// and this is the possible answer from first case that is A_B_C_C_ (By removing i == 0 and 1).
