...
// int find(int m,map<int,set<int>> mp,int ix)
// int fun(int n,int m,int l,int ix,int iy){
//     if(ix<0 || iy<0 || ix>n || iy>m){
//         return 0;
//     }

//     int a = fun(n,m,l,ix-l,iy) + 1;
//     int b = fun(n,m,l,ix+l,iy) + 1;
//     // int c = fun(n,m,l,ix,iy - l) + 1;
//     // int d = fun(n,m,l,ix,iy+l) + 1;
