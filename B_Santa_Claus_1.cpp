...
void ujjwal(){
    ...
    x--;y--;
    rep(i,sz(st)){
        if(st[i] == 'U' && x-1 >= 0 && veci[x-1][y] != '#'){
            if(veci[x-1][y]  == '@' && !vis[x-1][y]){
                vis[x-1][y] = 1;
                ans++;
            }
            x -= 1;
        }
        else if(st[i] == 'D' && x+1 < n && veci[x+1][y] != '#'){
            if(veci[x+1][y]  == '@' && !vis[x+1][y]){
                vis[x+1][y] = 1;
                ans++;
            }
        ...
        else if(st[i] == 'L' && y-1 >= 0 && veci[x][y-1] != '#'){
            if(veci[x][y-1]  == '@' && !vis[x][y-1]){
                vis[x][y-1] = 1;
                ans++;
            }
            y -= 1;
        }
        else if(st[i] == 'R' && y+1 < m &&  veci[x][y+1] != '#'){
            if(veci[x][y+1]  == '@' && !vis[x][y+1]){
                vis[x][y+1] = 1;
                ans++;
            }
