...
void ujjwal(){
    ...
    cin>>veci;
    ll r = veci[0]*veci[1];
    // if(veci[2] - veci[0] <= veci[3] - veci[1]){
    //     feach(i,veci[0]+1,veci[2]+1,1){
    //         if(i%r == 0){
    //             feach(j,i/r,veci[3]+1,i/r){
    //                 if(j > veci[1]){
    //                     out(i<<" "<<j);
    //                     rtn;
    //                 }
    ...
    // }
    // else{
    //     feach(i,veci[1]+1,veci[3]+1,1){
    //         if(i%r == 0){
    //             feach(j,i/r,veci[2]+1,i/r){
    //                 if(j > veci[0]){
    //                     out(i<<" "<<j);
    //                     rtn;
    //                 }
